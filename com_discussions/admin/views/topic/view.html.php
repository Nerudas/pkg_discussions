...
class DiscussionsViewTopic extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		$canDo      = DiscussionsHelper::getActions('com_discussions', 'topic', $this->item->id);

		if ($isNew)
		{
			// Add title
			JToolBarHelper::title(
				TEXT::_('COM_DISCUSSIONS') . ': ' . TEXT::_('COM_DISCUSSIONS_TOPIC_ADD'), 'comment'
			);
		...
		else
		{
			...
			// Add title
			JToolBarHelper::title(
				TEXT::_('COM_DISCUSSIONS') . ': ' . TEXT::_('COM_DISCUSSIONS_TOPIC_EDIT'), 'comment'
			);
