...
class DiscussionsViewCategories extends HtmlView
{
	/**
	 * An array of items
	 *
	...
	{
		DiscussionsHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		$canDo = DiscussionsHelper::getActions('com_discussions', 'categories');

		JToolBarHelper::title(Text::_('COM_DISCUSSIONS') . ': ' . Text::_('COM_DISCUSSIONS_CATEGORIES'), 'comment');

		if ($canDo->get('core.create') || count($user->getAuthorisedCategories('com_discussions', 'core.create')) > 0)
		{
