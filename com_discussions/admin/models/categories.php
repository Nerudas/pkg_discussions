...
class DiscussionsModelCategories extends ListModel
{
	/**
	 * Constructor.
	 *
		...
		if (is_array($tags))
		{
			...
			if (!empty($tags))
			{
				$query->join('LEFT', $db->quoteName('#__contentitem_tag_map', 'tagmap')
					...
					. ' AND ' . $db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_discussions.category'))
	...
	public function getItems()
	{
		...
		if (!empty($items))
		{
			foreach ($items as &$item)
			{
				...
				$item->tags->getItemTags('com_discussions.category', $item->id);
			}
		}
