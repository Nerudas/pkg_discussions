...
class DiscussionsModelPost extends AdminModel
{
	/**
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		if ($id != 0 && (!$user->authorise('core.edit.state', 'com_discussions.post.' . (int) $id)))
		{
	...
	{
		$data = Factory::getApplication()->getUserState('com_discussions.edit.post.data', array());
		if (empty($data))
		{
			$data = $this->getItem();
		}
